...
VALUES ('Corsair 4000D', 'Corsair', TRUE, 'ATX', 'ATX', 'Black', 85),
       ('NZXT H510', 'NZXT', TRUE, 'ATX', 'ATX', 'White', 70),
       ('Fractal Design Meshify C', 'Fractal Design', TRUE, 'ATX', 'ATX', 'Black', 100),
       ('Phanteks Eclipse P400A', 'Phanteks', TRUE, 'ATX', 'ATX', 'White', 90);

INSERT INTO COOLER (NAME, MANUFACTURER, WATER_COOLING, FAN_SIZE, RADIATOR_SIZE, RGB, SOCKET_TYPE, COLOR, PRICE)
VALUES ('Corsair H100i', 'Corsair', TRUE, 120, 240, TRUE, 'LGA1151', 'Black', 150),
       ('Noctua NH-D15', 'Noctua', FALSE, 140, NULL, FALSE, 'AM4', 'Brown', 90),
       ( 'NZXT Kraken X63', 'NZXT', TRUE, 140, 280, TRUE, 'LGA1200', 'Black', 160),
       ('Cooler Master Hyper 212 EVO', 'Cooler Master', FALSE, 120, NULL, FALSE, 'AM4', 'Black', 35);
...
INSERT INTO DATA (NAME, MANUFACTURER, DATA_MODEL, INTERFACE_TYPE, STORAGE_TYPE, WATTAGE_USAGE, CAPACITY,
                  CACHE_MEMORY, PRICE)
VALUES ('Samsung 970 Evo', 'Samsung', 'MZ-V7E1T0BW', 'NVMe', 'SSD', 5, 1000, 1024, 150),
       ('Seagate Barracuda', 'Seagate', 'ST1000DM010', 'SATA', 'HDD', 6, 1000, 64, 45),
       ('Western Digital Blue', 'Western Digital', 'WD10EZEX', 'SATA', 'HDD', 6, 1000, 64, 50),
       ('Crucial MX500', 'Crucial', 'CT1000MX500SSD1', 'SATA', 'SSD', 5, 1000, 512, 120);
...
VALUES ( 'Corsair RM750x', 'Corsair', 750, 'RM750x', '80+ Gold', 'ATX', 'Black', 130),
       ( 'EVGA SuperNOVA 850 G5', 'EVGA', 850, '850 G5', '80+ Gold', 'ATX', 'Black', 140),
       ('Seasonic Focus GX-650', 'Seasonic', 650, 'GX-650', '80+ Gold', 'ATX', 'Black', 110),
       ( 'Cooler Master V850', 'Cooler Master', 850, 'V850', '80+ Platinum', 'ATX', 'Black', 160);

INSERT INTO RAM (NAME, MANUFACTURER, WATTAGE_USAGE, MEMORY_CAPACITY, MEMORY_TYPE, TIMINGS, CLOCK_SPEED, PRICE)
VALUES ( 'G.SKILL Trident Z RGB', 'G.SKILL', 10, 16, 'DDR4', 16, 3200, 100),
       ( 'Corsair Vengeance LPX', 'Corsair', 9, 8, 'DDR4', 18, 3000, 50),
       ( 'Kingston HyperX Fury', 'Kingston', 10, 16, 'DDR4', 17, 3200, 90),
       ( 'Crucial Ballistix', 'Crucial', 9, 16, 'DDR4', 16, 3600, 110);

INSERT INTO PCBUILDS (BUILD_NAME, CPU_ID, MOBO_ID, GPU_ID, RAM_ID, CHASSIS_ID, COOLER_ID, STORAGE_ID, PSU_ID, MEMORY_QUANTITIES, STORAGE_QUANTITIES)
